...
VERSION_HISTORY = [
    {
        ...
        'type': 'minor',
        'changes': [
            '✨ NEW FEATURE: Nmap scan history tracking with change detection',
            ...
            '📊 DATABASE: Created nmap_scans.db with 3 tables',
            ...
            'FRONTEND: Change type icons: 🔓 Port Opened, 🔒 Port Closed, 💻 OS Changed, 🔄 Service Updated',
            ...
            'UI: "View Scan History" button with 📊 icon in scan results',
    ...
    },
    {
        ...
        'type': 'patch',
        'changes': [
            '🐛 FIX: Nmap scan timeout increased to prevent false failures',
    ...
    },
    {
        ...
        'type': 'patch',
        'changes': [
            '✨ NEW FEATURE: Nmap network scanning for connected devices',
            ...
            '🔒 SECURITY: RFC 1918 IP validation (10.x, 172.16-31.x, 192.168.x only)',
    ...
    },
    {
        ...
        'type': 'patch',
        'changes': [
            '✨ NEW FEATURE: Search box added to DHCP Leases screen',
            ...
            'NEW: Sort indicators (▲/▼) on table headers',
            'NEW: Search filters by IP, MAC, hostname, interface, and state',
            'NEW: Hover effects on table rows for better UX',
            '🐛 CRITICAL FIX: Dashboard threat tiles now show UNIQUE counts matching modal counts',
    ...
    },
    {
        ...
        'type': 'patch',
        'changes': [
            '✨ CONSISTENCY: Dashboard time windows aligned with Connected Devices page',
    ...
    },
    {
        ...
        'type': 'patch',
        'changes': [
            '✨ NEW FEATURE: Total Volume column added to Connected Devices table',
            ...
            'NEW: getSortIndicator() helper function for sortable column indicators (▼/▲)',
    ...
    },
    {
        ...
        'type': 'patch',
        'changes': [
            '🐛 CRITICAL FIX: Medium Threats and Blocked URLs modals now display actual timestamps',
            '🐛 CRITICAL FIX: Modals now show last 5 UNIQUE entries (no duplicates)',
    ...
    },
    {
        ...
        'type': 'patch',
        'changes': [
            '🐛 CRITICAL FIX: Dashboard Top Categories now match Applications page data',
            '🐛 CRITICAL FIX: Dashboard Top Applications now sorted by bandwidth (bytes), not sessions',
            '🐛 CRITICAL FIX: Threat/URL modals now show last 5 unique entries only (no repeated threats/URLs)',
    ...
    },
    {
        ...
        'type': 'patch',
        'changes': [
            '🐛 CRITICAL FIX: Resolved throughput graph drops to zero',
